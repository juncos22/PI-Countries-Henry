        ...
        <div>
            <div className={styles.row}>
                <div className={styles.col}>
                    ...
                    <div className={styles.countrySubtitle}>
                        <div className={styles.col}>
            ...
            <div className={styles.col}>
                {
                    countryDetail.Activities?.length > 0
                        ? <h3 className={styles.activityTitle}>Actividades Turisticas</h3>
                        : <h3 className={styles.activityTitle}>No hay actividades disponibles</h3>
                }
                <div className="row">
                    {
                        countryDetail.Activities?.length > 0
